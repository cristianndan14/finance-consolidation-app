...
## Cómo clasifica esta persona

Abajo están clasificaciones que **esta persona ya corrigió a mano** en meses
anteriores. No son ejemplos de manual: son el criterio real de este usuario, y
donde su criterio y el tuyo no coincidan, manda el suyo.

Usalas para dos cosas:

- Si alguna de las descripciones de abajo se parece mucho a una de la lista que
  te paso, clasificala igual.
- Si el usuario mandó sistemáticamente un tipo de comercio a una categoría que no
  es la más obvia, seguí ese criterio en los casos parecidos.

No las copies a la salida: son contexto, no preguntas. Y si la lista está vacía,
ignorá esta sección y clasificá con las reglas de arriba.
